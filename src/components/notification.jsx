...
export default function Notification() {
  const [message, setMessage] = useRecoilState(notificationMessageAtom);
  const [type, setType] = useRecoilState(notificationTypeAtom);
  const [show, setShow] = useRecoilState(notificationAtom);
  useEffect(()=>{
